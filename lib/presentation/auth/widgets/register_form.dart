                          ...
                          child: Column(
                            children: [
                              ...
                              InputField(
                                ...
                                onChanged: (value) => context
                                    .read<RegisterFormBloc>()
                                    .add(RegisterFormEvent.phoneNumberChanged(
                                        value!)),
                                validator: (_) => context
                                    .read<RegisterFormBloc>()
                                    .state
                              ...
                              InputField(
                                ...
                                onChanged: (value) => context
                                    .read<RegisterFormBloc>()
                                    .add(RegisterFormEvent.passwordChanged(
                                        value!)),
                                validator: (_) => context
                                    .read<RegisterFormBloc>()
                                    .state
                              ...
                              InputField(
                                ...
                                onChanged: (value) => context
                                    .read<RegisterFormBloc>()
                                    .add(RegisterFormEvent.collegeChanged(
                                        value!)),
                                validator: (_) => context
                                    .read<RegisterFormBloc>()
                                    .state
                      ...
                      content: Wrap(
                        children: <Widget>[
                            ...
                            children: [
                              Expanded(
                                child: GestureDetector(
                                  ...
                                  child: mycircle("BTECH", btechCircleHeight,
                                      btechCircleColor),
                                ),
                              ),
                              Expanded(
                          ...
                          GestureDetector(
                              ...
                              child: mycircle("DPHARMA", dpharmaCircleHeight,
                                  dpharmaCircleColor)),
                        ],
                      ),
                      isActive: _currentStep >= 0,
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  setState(() {
                                    ...
                                    civilCircleColor = Apptheme.secondaryColor;
                                ...
                                child: mycircle(
                                    "CSE", cseCircleHeight, cseCircleColor),
                              ),
                            ),
                            Expanded(
                              child: GestureDetector(
                            ...
                            children: [
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      ...
                                      civilCircleColor = Apptheme.primaryColor;
                              ...
                              Expanded(
                                child: GestureDetector(
                                  ...
                                  child: mycircle(
                                      " I  T ", itCircleHeight, itCircleColor),
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              Expanded(
                                child: GestureDetector(
                                  ...
                                  child: mycircle(" E C E", eceCircleHeight,
                                      eceCircleColor),
                                ),
                              ),
                              Expanded(
