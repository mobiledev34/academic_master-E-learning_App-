...
class _$ValueFailureTearOff {
  ...
  InvalidBtechBranch<T> invalidBtechBranch<T>(T failedValue) {
    return InvalidBtechBranch<T>(
      failedValue,
    );
  }

  InvalidCourse<T> invalidCourse<T>(T failedValue) {
    return InvalidCourse<T>(
      failedValue,
    );
  }

  InvalidCollege<T> invalidCollege<T>(T failedValue) {
    return InvalidCollege<T>(
      failedValue,
    );
  }

  InvalidYear<T> invalidYear<T>(T failedValue) {
    return InvalidYear<T>(
      failedValue,
    );
  }

  InvalidDpharmaYear<T> invaliDpharmaYear<T>(T failedValue) {
    return InvalidDpharmaYear<T>(
      failedValue,
    );
  }
...
/// @nodoc
abstract class $InvalidBtechBranchCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $InvalidBtechBranchCopyWith(InvalidBtechBranch<T> value,
          $Res Function(InvalidBtechBranch<T>) then) =
      _$InvalidBtechBranchCopyWithImpl<T, $Res>;
  @override
  $Res call({T failedValue});
}
...
class _$InvalidBtechBranchCopyWithImpl<T, $Res>
  ...
  _$InvalidBtechBranchCopyWithImpl(
      InvalidBtechBranch<T> _value, $Res Function(InvalidBtechBranch<T>) _then)
      : super(_value, (v) => _then(v as InvalidBtechBranch<T>));

  @override
  InvalidBtechBranch<T> get _value => super._value as InvalidBtechBranch<T>;
...
/// @nodoc
abstract class $InvalidCourseCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $InvalidCourseCopyWith(
          InvalidCourse<T> value, $Res Function(InvalidCourse<T>) then) =
      _$InvalidCourseCopyWithImpl<T, $Res>;
  @override
  $Res call({T failedValue});
}
...
class _$InvalidCourseCopyWithImpl<T, $Res>
  ...
  _$InvalidCourseCopyWithImpl(
      InvalidCourse<T> _value, $Res Function(InvalidCourse<T>) _then)
      : super(_value, (v) => _then(v as InvalidCourse<T>));

  @override
  InvalidCourse<T> get _value => super._value as InvalidCourse<T>;
...
/// @nodoc
abstract class $InvalidCollegeCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $InvalidCollegeCopyWith(
          InvalidCollege<T> value, $Res Function(InvalidCollege<T>) then) =
      _$InvalidCollegeCopyWithImpl<T, $Res>;
  @override
  $Res call({T failedValue});
}
...
class _$InvalidCollegeCopyWithImpl<T, $Res>
  ...
  _$InvalidCollegeCopyWithImpl(
      InvalidCollege<T> _value, $Res Function(InvalidCollege<T>) _then)
      : super(_value, (v) => _then(v as InvalidCollege<T>));

  @override
  InvalidCollege<T> get _value => super._value as InvalidCollege<T>;
...
/// @nodoc
abstract class $InvalidDpharmaYearCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $InvalidDpharmaYearCopyWith(InvalidDpharmaYear<T> value,
          $Res Function(InvalidDpharmaYear<T>) then) =
      _$InvalidDpharmaYearCopyWithImpl<T, $Res>;
  @override
  $Res call({T failedValue});
}
...
class _$InvalidDpharmaYearCopyWithImpl<T, $Res>
  ...
  _$InvalidDpharmaYearCopyWithImpl(
      InvalidDpharmaYear<T> _value, $Res Function(InvalidDpharmaYear<T>) _then)
      : super(_value, (v) => _then(v as InvalidDpharmaYear<T>));

  @override
  InvalidDpharmaYear<T> get _value => super._value as InvalidDpharmaYear<T>;
